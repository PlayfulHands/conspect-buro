...
onMounted(() => {
  const paymentData = `ST00012|Name=Конспект Бюро|PersonalAcc=89965697285|BankName=СБЕРБАНК|Sum=${price.value * 100}|Purpose=Заказ №${orderId.value}`
  QRCode.toCanvas(qrCode.value, paymentData, { width: 220 })
})
